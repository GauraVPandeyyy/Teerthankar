  ...
  return (
    ...
    >
      <Link to={`/product/${product.id}`}>
        <Card className={cn(
          "group relative overflow-hidden bg-white/80 backdrop-blur-sm border border-white/50 shadow-sm hover:shadow-2xl transition-all duration-500 rounded-3xl h-full",
          ...
          {/* Image Container */}
          <div className="relative overflow-hidden aspect-square rounded-3xl">
            <motion.img
            ...
            <div className="absolute top-3 left-3 flex flex-col gap-2">
              {discount > 0 && (
                <motion.span 
                  className="bg-gradient-to-r from-rose-500 to-rose-600 text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-lg"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
              ...
              {product.featured && (
                <motion.span 
                  className="bg-gradient-to-r from-amber-500 to-amber-600 text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-lg flex items-center gap-1"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
