...
import { ArrowLeft, ChevronRight, Sparkles, Filter, RefreshCw } from 'lucide-react';
...
const CategoryPage: React.FC = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-rose-50/30">
        <div className="text-center">
          ...
          <p className="text-slate-600 mb-6">Unable to fetch category data. Please try again.</p>
          <Button 
            onClick={refetchData}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-rose-50/30">
      {/* Loading state for category data */}
      {isLoading && !category ? (
